/*
 * hl_classic_module_bluetooth_check
 * 
 * Проверка модуля Bluetooth ХЛ классический
 * 
 * Модуль Bluetooth подключен в разъем 3
 * 
...
const byte ALT_RX_PIN = A3;
const byte ALT_TX_PIN = A2;
