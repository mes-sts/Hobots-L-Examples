/*
 * hl_ultra_massive_sensor_check
 * 
 * Проверка массива инфракрасных датчиков HL Ультра
 * 
 * Датчик подключен в PORT2
 * 
 * Ссылка на библиотеку https://github.com/mes-sts/MES-Arduino-Libs/tree/main/IR-Sensors-Array
 * 
